...
<h2 class="text-center">Insert Catergories</h2>
...
<input type="submit" class="bg-info border-0 p-2 my-3" name="insert_cat" value="Insert catergories" placeholder="insert catergories" aria-label="Username" aria-describedby="basic-addon1">
